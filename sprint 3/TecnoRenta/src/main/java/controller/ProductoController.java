...
public class ProductoController implements IProductoController {
    ...
    public String listar(boolean ordenar, String orden) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Productos producto = new Productos(id, tipo, referencia, marca, cantidad, novedad);
    ...
    public String sumarCantidad(int id) {
        ...
        String sql = "Update producto set cantidad = (Select cantidad from producto where id = " 
                + id + ") + 1 where id = " + id;
    ...
    public String modificar(int id) {
        ...
        DBConnection con = new DBConnection();
        String sql = "Update producto set cantidad = (cantidad - 1) where id = " + id;
